...
class Configuration extends Component {
    ...
    public function update() {
        ...
        $settings = Setting::whereIn('key', ['domains', 'fetch_seconds', 'forbidden_ids', 'blocked_domains', 'cron_password', 'delete', 'random', 'after_last_email_delete', 'date_format', 'recaptcha'])->get();
